        ...
        <div class="tarjeta-curso" id="tarjeta-${curso.id}">
            <div class="tarjeta-header" onclick="togglePanelNotas('${curso.id}')">
                ...
                <div class="caja-promedio" style="position:relative;">
                    ...
                    <button type="button" id="badge-oficial-${curso.id}" style="display:none; position:absolute; top:3px; right:68px; width:14px; height:14px; border:none; background:none; box-shadow:none; -webkit-appearance:none; appearance:none; color:#9ca3af; font-size:0.75rem; line-height:1; cursor:pointer; padding:0;"
